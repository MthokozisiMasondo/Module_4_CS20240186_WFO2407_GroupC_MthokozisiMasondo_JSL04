...
let preferenceDisplay = userPreference ? userPreference : "Regular"
console.log(`${preferenceDisplay}`);
...
console.log(`Number of cans left: ${cansLeft}. ${stock}`);
...
let shouldDrink = heartRate < 100 ? "Boost needed!" : "Energy levels are high!"
console.log(`Your heart rate is ${heartRate}. ${shouldDrink}`);
...
let beerTemp = currentTemp <= 5 ? "Chilled to perfection!" : "Needs a cooler!"
console.log(`${beerTemp}`);
...
let currentHour = 23; 
let drinkingTime = currentHour >= 7 && currentHour <= 24 ? "Unleast the beast!" : "Better stick to water"
console.log(`${drinkingTime}`)
